...
//
#ifndef CONFIG_H
 // #define NAME "42nibbles ESP32-Rundfunkgerät"                              // Define name of the radio, also AP SSID,
 ...
 #define FIXEDWIFI "UZB-76 2.4GHz/Mr0alibaba###"                    // Add a fixed SSID to the list (WiFi only)
